...
public class _99BillSendData {
    ...
    private Map<String, String> buildParamsMap(boolean type) {
        ...
        sParaTemp.put("payType", Strings.nullToEmpty(this.payType));
        ...
        sParaTemp.put("redoFlag", Strings.nullToEmpty(this.redoFlag));
        ...
        if (!type) {
            sParaTemp.put("mobileGateway", Strings.nullToEmpty(this.mobileGateway));
        }
        return sParaTemp;
    }
