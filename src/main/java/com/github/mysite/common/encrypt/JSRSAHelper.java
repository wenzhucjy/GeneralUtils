...
/**
 * description: RSA加密工具类，用于security.js的双向解密
 *
 * @author : jy.chen
 * @version : 1.0
 * @since : 2016-03-07 13:59
 */
public class JSRSAHelper {
     ...
     */
    private static final Logger LOG = LoggerFactory.getLogger(JSRSAHelper.class);
    /**
     * 算法名称
     */
    ...
    private static String getRSAPairFilePath() {
        String urlPath = JSRSAHelper.class.getResource("/").getPath();
